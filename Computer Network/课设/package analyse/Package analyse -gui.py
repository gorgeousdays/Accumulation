...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # 筛选按钮
        self.select_btn = QPushButton("筛选报文")
        self.select_btn.setFixedSize(200, 60)
        button_layout.addWidget(self.select_btn)
        self.select_btn.clicked.connect(self._select)
        self.select_btn.setStyleSheet('''QPushButton{background:rgb(106,118,200);border-radius:5px;color:white;font-family:AdobeHeitiStd;font-size:25px}
                                        QPushButton:hover{background:rgb(93,156,236);}
                                        QPushButton:pressed{background-color:rgb(74,137,220)}''')      
        # 清空列表按钮
